...
import StaticBoardView from "../../../Components/StaticTasks/StaticBoardView"
import StaticListView from "../../../Components/StaticTasks/StaticListView"
import StaticTaskModal from "../../../Components/StaticTasks/StaticTaskModal"
import StaticTaskDetail from "../../../Components/TaskDetails/TaskDetail"
        ...
        {showTaskDetail && selectedTaskData ? (
          ...
          <>
            <div className="flex justify-between items-center mb-6">
              <h1 className="text-2xl font-bold">In Progress Board</h1>
            </div>
